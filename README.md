...
<p>
  <img alt="Next.js 16" src="https://img.shields.io/badge/Next.js_16-000?logo=nextdotjs&logoColor=white">
  <img alt="React Flow" src="https://img.shields.io/badge/React_Flow-FF0072?logo=react&logoColor=white">
  ...
  <img alt="WebSockets" src="https://img.shields.io/badge/WebSockets-010101?logo=socketdotio&logoColor=white">
  ...
  <img alt="OpenAI" src="https://img.shields.io/badge/OpenAI_embeddings-412991?logo=openai&logoColor=white">
  <img alt="Inngest" src="https://img.shields.io/badge/Inngest-3B82F6?logo=inngest&logoColor=white">
  ...
  <img alt="Render" src="https://img.shields.io/badge/Render-000?logo=render&logoColor=white">
  <img alt="pnpm" src="https://img.shields.io/badge/pnpm-F69220?logo=pnpm&logoColor=white">
  <img alt="uv" src="https://img.shields.io/badge/uv-DE5FE9?logo=astral&logoColor=white">
</p>

<p align="center">
  <img src="docs/screenshots/hero.gif" width="80%" alt="CanvasAI — animated intro">
</p>
...
| Light                                                                | Dark                                                               |
| -------------------------------------------------------------------- | ------------------------------------------------------------------ |
| <img src="docs/screenshots/landing-light.png" alt="Landing — light"> | <img src="docs/screenshots/landing-dark.png" alt="Landing — dark"> |

**The visual canvas** — your question, drawn as interactive nodes

| Light                                                              | Dark                                                             |
| ------------------------------------------------------------------ | ---------------------------------------------------------------- |
| <img src="docs/screenshots/canvas-light.png" alt="Canvas — light"> | <img src="docs/screenshots/canvas-dark.png" alt="Canvas — dark"> |

**Overview** — your past sessions as a spatial map

| Light                                                                  | Dark                                                                 |
| ---------------------------------------------------------------------- | -------------------------------------------------------------------- |
| <img src="docs/screenshots/overview-light.png" alt="Overview — light"> | <img src="docs/screenshots/overview-dark.png" alt="Overview — dark"> |

**Active Recall** — auto-generated SM-2 flashcards

| Light                                                                     | Dark                                                                    |
| ------------------------------------------------------------------------- | ----------------------------------------------------------------------- |
| <img src="docs/screenshots/recall-light.png" alt="Active Recall — light"> | <img src="docs/screenshots/recall-dark.png" alt="Active Recall — dark"> |
...
| Light                                                             | Dark                                                            |
| ----------------------------------------------------------------- | --------------------------------------------------------------- |
| <img src="docs/screenshots/notfound-light.png" alt="404 — light"> | <img src="docs/screenshots/notfound-dark.png" alt="404 — dark"> |

## 🎬 Animated Explainers

These are short animations we built to explain the ideas.

**Neuroprofiles** — the same lesson, re-rendered for Spatial, Micro-step, and Low-stim

<div align="center"><img src="docs/screenshots/neuroprofiles.gif" width="80%" alt="Neuroprofiles re-rendering the lesson"></div>
...
<div align="center"><img src="docs/screenshots/architecture.png" width="92%" alt="CanvasAI architecture & workflow"></div>
