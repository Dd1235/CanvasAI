...
const InfiniteMenu: FC<InfiniteMenuProps> = ({ items = [], scale = 1.0 }) => {
  ...
  const handleButtonClick = () => {
    ...
    if (activeItem.link.startsWith('http')) {
      ...
      // In a Next.js app, you might want to use router.push(activeItem.link) here
        ...
        `}
          ...
          ${
            isMoving
              ...
              : 'opacity-100 pointer-events-auto duration-[500ms] translate-x-[-20%] md:translate-x-[-50%] -translate-y-1/2'
          }
        `}
          >
